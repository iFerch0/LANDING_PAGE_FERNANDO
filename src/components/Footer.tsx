      ...
      <div className={styles.main}>
        <div className="container">
          <div className={styles.grid}>
            ...
            <div className={`${styles.section} ${styles.brand}`} data-aos="fade-up" data-aos-delay="100">
            ...
            <div className={styles.section} data-aos="fade-up" data-aos-delay="300">
              ...
              <div className={styles.contactMethods}>
                <a href={`tel:${contactInfo.phone}`} className={`${styles.contactItem} ${styles.contactPhone}`}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                  <div>
                ...
                <a
                  ...
                  className={`${styles.contactItem} ${styles.contactWhatsapp}`}
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <span className={styles.contactValue}>Mensaje Directo</span>
                  </div>
                </a>
              ...
              <div className={styles.businessHours}>
                <h5 className={styles.hoursTitle}>Horarios de Atención</h5>
          ...
          <div className={styles.bottomContent}>
            ...
            <div className={styles.right}>
              <div className={styles.links}>
                ...
                <a href="/terms" className={styles.link}>Términos de Servicio</a>
                <a href="/sitemap" className={styles.link}>Mapa del Sitio</a>
              </div>

              <div className={styles.certificationsMini}>
                <div className={styles.certMini}>
