    ...
    provider: {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          {
            '@type': 'Offer',
            itemOffered: { '@type': 'Service', name: 'Reparación de Computadores' },
          },
          {
            '@type': 'Offer',
            itemOffered: { '@type': 'Service', name: 'Mantenimiento Preventivo' },
          },
          {
            '@type': 'Offer',
            itemOffered: { '@type': 'Service', name: 'Soporte Técnico' },
          },
        ],
      },
