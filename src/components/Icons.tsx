...
export const PhoneIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Teléfono' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const CodeIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Código' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const GlobeIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Web' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const LayoutIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Diseño' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const RocketIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Lanzar' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const HomeIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Inicio' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ContactIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Contacto' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const LaptopIcon: React.FC<IconProps> = ({ className, size = 20, title = 'Laptop' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const CameraIcon: React.FC<IconProps> = ({ className, size = 18, title = 'Cámara' }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const CloseIcon: React.FC<IconProps> = ({ className, size = 24, title = 'Cerrar' }) => (
  <svg
    className={className}
    width={size}
    height={size}
