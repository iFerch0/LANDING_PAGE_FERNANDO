...
export const metadata: Metadata = {
  ...
  description:
    'Cobertura de servicios técnicos en Montería Centro: reparaciones, soporte y recuperación de datos.',
};
  ...
  return (
    <main>
      <div className="container">
        ...
        <p>Atendemos reparaciones, soporte y mantenimiento en la zona céntrica de Montería.</p>
        <p>
