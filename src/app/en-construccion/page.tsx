        ...
        <div className="container">
          <div className="hero__content hero__layout">
            <div className="hero__copy">
              ...
              <h1 id="construccion-title" className="hero__title">
                Estamos construyendo algo increíble
              </h1>
              <p className="hero__subtitle">
                Nuestro equipo está trabajando para traerte una experiencia excepcional. Esta
                sección estará disponible pronto con contenido especializado.
              </p>
              ...
              <div className="construccion-meta" style={{ marginTop: '28px' }}>
                <div className="construccion-progress" aria-hidden>
                  ...
                  <div
                    className="construccion-progress-bar"
                    style={{
                      height: '8px',
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: '100%',
                        background:
                          'linear-gradient(90deg,var(--brand-azul_vibrante),var(--color-teal-500))',
                      }}
                    ></div>
                  </div>
                </div>
