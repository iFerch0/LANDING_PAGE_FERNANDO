...
export default function Page() {
  return (
    <ServiceTemplate
      ...
      cases={[{ title: 'Limpieza y thermal', text: 'Limpieza completa y cambio de pasta térmica, reducción de temperatura 12°C.' }]}
      faqs={[{ q: '¿Incluye limpieza de ventilador?', a: 'Sí, limpieza completa y revisión de ventilador.' }]}
    />
  );
}
