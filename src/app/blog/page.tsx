...
export const metadata: Metadata = {
  ...
  description:
    'Artículos, guías y consejos expertos sobre mantenimiento de computadores, reparación PC y soporte técnico en Montería. Información útil para cuidar tu equipo.',
  alternates: {
...
const blogPosts: BlogPost[] = [
  {
    ...
    description:
      'Todo lo que necesitas saber sobre el mantenimiento preventivo y correctivo de tu computador en Montería.',
    date: '2025-01-15',
  ...
  },
  {
    ...
    description:
      'Identifica los síntomas que indican que tu computador necesita atención profesional.',
    date: '2025-01-10',
